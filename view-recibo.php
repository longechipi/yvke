...
?>
<?php include('marcos/header.php'); $cedula = $_SESSION['cedula'];?>
      ...
      $(document).ready(function(){
        $("#anocur").change(function () {
          ...
          $("#anocur option:selected").each(function () {
            anocur = $(this).val();
            $.post("ajax/reciboSigesp-2019.php", { anocur: anocur }, function(data){
              $("#mes").html(data);
            });            
          });
        })
      ...
      $(document).ready(function(){
        $("#mes").change(function () {
          $("#mes option:selected").each(function () {
            mes = $(this).val();
            $.post("ajax/recibo-2019.php", { mes: mes }, function(data){
              $("#quinc").html(data);
            });            
          });
        })
    ...
    <script language="javascript">
      $(document).ready(function(){
        $("#anocur").change(function () {
          ...
          $("#anocur option:selected").each(function () {
            anocur = $(this).val();
            $.post("ajax/reciboSigesp-2021.php", { anocur: anocur }, function(data){
              $("#mes").html(data);
            });            
          });
        })
...
<select name="quinc" id="quinc"class="form-control"><option value="">Seleccione Quincena</option></select>
<br/>
...
<div class="card shadow mb-4">
<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
<h6 class="m-0 font-weight-bold text-primary">Recibos del Año 2021 (Bs Soberanos)</h6>
</div>
<div class="card-body text-center">
<form target="_blank" action="pdf/reciboSigesp.php" method="post">
<strong>Seleccione Año</strong>
