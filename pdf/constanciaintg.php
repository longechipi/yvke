...
$pdf->SetFont('Times','',12);
$pdf->Ln(15);
$pdf->MultiCell(0, 7, utf8_decode('Por medio de la presente, el departamento de Talento Humano de YVKE MUNDIAL hace constar que el(la) ciudadano(a): '.$nom_tra.' portador de la Cédula de Identidad N° '.$ced_tra.' desempeña sus funciones en la Institución desde el '.$fe_ing.', adscrito a la '.$nomGere.' con el cargo de '.$usu_car.' devengando un salario Integral de Bs. '.number_format(($suel_int),2,",",".").' ('.$V->ValorEnLetras($suel_int).') y adicionalmente el trabajador recibe el Beneficio de Alimentación por un monto de BsS. 3.000.000,00 Bs'), 0,'FJ');
