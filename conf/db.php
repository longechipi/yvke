...
$host        = "host = 127.0.0.1";
$port        = "port = 5432";
$dbname      = "dbname = 2021_radio_mundial";
$credentials = "user = postgres password=12345";
   $conP = pg_connect( "$host $port $dbname $credentials"  );
   if(!$conP) {
    echo "<center><h1>¡Error en parametros de conexion con la Base de Dato Sigesp! </h1></center>";  
   }
...
$credentials2 = "user = postgres password=12345";
   ...
   if(!$conU) {
    echo "<center><h1>¡Error en parametros de conexion con la Base de Dato Usuarios!</h1></center>";  
   }
